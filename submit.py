...
#--------------------------------------------------------------
# out_dir  = RESULTS_DIR + '/mask-rcnn-0314/'
# initial_checkpoint = RESULTS_DIR + '/mask-rcnn-0314/checkpoint/00005500_model.pth'
def run_submit():
    ...
    set_name = 'filenames/%s_test.csv' % (split)
    data_dir = '/home/htang6/workspace/data/dsb2018/stage1_test/'
    test_dataset = ScienceDataset(data_dir,  set_name, mode='test', transform = submit_augment)
...
def run_npy_to_sumbit_csv():
    ...
    out_dir = args.out_dir
    split = args.split
    image_dir   = '/home/htang6/workspace/data/dsb2018/stage1_test/images'
    submit_dir  = out_dir + '/submit'
    npy_dir = submit_dir  + '/npys'
    csv_file = submit_dir + '/%s.csv' % (split)
